    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Controls whether the notification is cancelled automatically when the user clicks on it
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bigText.bigText("This is one big texthjkhjkhgfhjjjjjjjjs is one big text" +
                        "This is one big texthjkhjkhgfhjjjjjjjjs is one big text" +
                        "This is one big texthjkhjkhgfhjjjjjjjjs is one big text" +
                        "This is one big texthjkhjkhgfhjjjjjjjjs is one big text" +
                        "This is one big texthjkhjkhgfhjjjjjjjjs is one big text" +
                        "This is one big texthjkhjkhgfhjjjjjjjjs is one big text" +
                        "vThis is one big texthjkhjkhgfhjjjjjjjjs is one big text");
